...
// Esta classe Ã© responsÃ¡vel por coletar os dados do usuÃ¡rio e criar instÃ¢ncias de Peixe, MamÃ­fero ou Ave.
public class Cadastro_Animais {
    public static void main(String[] args) {
        ...
        if (escolha == 1) {
            ...
            String alimento = JOptionPane.showInputDialog("Alimento do mamÃ­fero: ");
