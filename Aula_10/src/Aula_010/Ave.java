...
public class Ave extends Animal {
    ...
    // MÃ©todo para exibir os dados da ave:
    // Este mÃ©todo exibe uma mensagem com os dados da ave em uma caixa de diÃ¡logo.
    ...
    public static void main(String[] args) {
        ...
        String reproducao      = JOptionPane.showInputDialog("Digite o tipo de reproduçãoo da ave:");
        String fecundacao      = JOptionPane.showInputDialog("Digite o tipo de fecundaçãoo da ave:");
