...
// Esta classe representa um mamÃ­fero, que Ã© um tipo especÃ­fico de animal.
public class Mamifero extends Animal {
    private String alimento;

    // Construtor da classe Mamifero:
    // Este construtor inicializa os atributos do mamÃ­fero com os valores fornecidos.
    ...
    // MÃ©todo para exibir os dados do mamÃ­fero:
    // Este mÃ©todo exibe uma mensagem com os dados do mamÃ­fero em uma caixa de diÃ¡logo.
    public void dadosMamifero() {
        super.dados();
        JOptionPane.showMessageDialog(null, "Alimento: " + alimento, "Informação do Mamífero", JOptionPane.INFORMATION_MESSAGE);
    }
